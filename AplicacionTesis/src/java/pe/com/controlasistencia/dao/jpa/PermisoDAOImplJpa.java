...
public class PermisoDAOImplJpa implements PermisoDAO {

    private EntityManager em;
    private static Logger log = Logger.getLogger(PermisoDAOImplJpa.class);

    public PermisoDAOImplJpa() {
        this.em = JPAUtil.getEntityManager();
    }

    @Override
    public List<Permiso> listar() {
        TypedQuery<Permiso> query = em.createQuery("select c From Permiso", Permiso.class);
    ...
    public Permiso get(Integer atributo_id) {
        ...
        return em.find(Permiso.class, atributo_id);
    }
