...
public class TurnoDAOImplJpa implements TurnoDAO {

    private EntityManager em;
    private static Logger log = Logger.getLogger(TurnoDAOImplJpa.class);

    public TurnoDAOImplJpa() {
        this.em = JPAUtil.getEntityManager();
    }

    @Override
    public List<Turno> listar() {
        TypedQuery<Turno> query = em.createQuery("select c From Turno", Turno.class);
    ...
    public Turno get(Integer atributo_id) {
        ...
        return em.find(Turno.class, atributo_id);
    }
