...
public class InterfazDAOImplJpa implements InterfazDAO {

    private EntityManager em;
    private static Logger log = Logger.getLogger(InterfazDAOImplJpa.class);

    public InterfazDAOImplJpa() {
        this.em = JPAUtil.getEntityManager();
    }

    @Override
    public List<Interfaz> listar() {
        TypedQuery<Interfaz> query = em.createQuery("select c From Interfaz", Interfaz.class);
    ...
    public Interfaz get(Integer atributo_id) {
        ...
        return em.find(Interfaz.class, atributo_id);
    }
