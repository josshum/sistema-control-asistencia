...
public class AdminAsistenciaDAOImplJpa implements AdminAsistenciaDAO {

    private EntityManager em;
    private static Logger log = Logger.getLogger(AdminAsistenciaDAOImplJpa.class);

    public AdminAsistenciaDAOImplJpa() {
        this.em = JPAUtil.getEntityManager();
    }

    @Override
    public List<AdminAsistencia> listar() {
      TypedQuery<AdminAsistencia> query = em.createQuery("select c From AdminAsistencia", AdminAsistencia.class);
    ...
    public AdminAsistencia get(Integer atributo_id) {
        ...
        return em.find(AdminAsistencia.class, atributo_id);
    }
